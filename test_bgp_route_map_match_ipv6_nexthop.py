...
def topology(topo):
    ...
    topo.router("r2").lo_ip6.append("2001:db8:1::1/128")
    topo.router("r2").lo_ip6.append("2001:db8:2::1/128")
    topo.router("r2").lo_ip6.append("2001:db8:3::1/128")
    topo.router("r2").lo_ip6.append("2001:db8:4::1/128")
    topo.router("r2").lo_ip6.append("2001:db8:5::1/128")
...
class TestBGPRouteMapMatchIPV6NextHopAccessList(TestBase, AutoFixture, setup=Setup):
    @topotatofunc
